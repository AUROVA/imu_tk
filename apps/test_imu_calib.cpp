...
int main(int argc, char** argv)
{
  ...
  importAsciiData( argv[1], acc_data, imu_tk::TIMESTAMP_UNIT_SEC, imu_tk::DATASET_COMMA_SEPARATED );
  cout<<"Importing IMU data from the Matlab matrix file : "<< argv[2]<<endl;  
  importAsciiData( argv[2], gyro_data, imu_tk::TIMESTAMP_UNIT_SEC, imu_tk::DATASET_COMMA_SEPARATED );
